                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    <h4 class="mb-4">Kenapa harus Stanpro?</h4>
                                    <p class="small mb-0">Stanpro Learning Center adalah lembaga pendidikan dan
                                        pelatihan yang fokus utamanya menyiapkan para siswa untuk lulus dan menjadi
                                        bagian dari Sekolah Kedinasan, militer dan Pegawai Negeri Sipil.</p>
                                </div>
                            </div>
                        </div>
                    </div>
